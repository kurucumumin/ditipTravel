                ...
                <ClientSideEvents ContextMenuItemClick="OnContextMenuItemClick" />
                  ...
                  <Columns>
                      ...
                      <dx:GridViewDataTextColumn FieldName="surname" VisibleIndex="2" Caption="Soyisim"></dx:GridViewDataTextColumn>
                         <dx:GridViewDataTextColumn FieldName="username" VisibleIndex="3" Caption="Kullanıcı Adı"></dx:GridViewDataTextColumn>
                      <dx:GridViewDataTextColumn FieldName="password" VisibleIndex="4" Caption="Şifre">
                          <PropertiesTextEdit Password="True"></PropertiesTextEdit>  
                      </dx:GridViewDataTextColumn>
                       <dx:GridViewDataCheckColumn FieldName="status" Caption="Aktif" VisibleIndex="5"></dx:GridViewDataCheckColumn>
                  </Columns>
