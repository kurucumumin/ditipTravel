<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="excel-siparis-yukleme.aspx.cs" Inherits="PortCRMWeb.excel_siparis_yukleme" %>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Sipariş Yükleme</h1>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="main.aspx">Anasayfa</a></li>
                                    <li class="breadcrumb-item active">Sipariş Yükleme</li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
                ...
                <div class="content" style="padding-left: 30px; padding-right: 30px;">
                     ...
                     <div class="form-row" id="dosyaDokumanXLSX" runat="server">
                        <div class="col-3">
                            <span>Sipariş Yükleme Dosyası (.XLSX)</span>
                        </div>
                        <div class="col-2">
                            <asp:Button ID="btnDokumanEkleXLSX" runat="server" class="btn btn-success" Text="Sipariş Dosyası Ekle" OnClick="btnDokumanEkleXLSX_Click" />
                        </div>
                    </div>
                    ...
                    <dx:ASPxPopupControl ID="PopupMessageBoxDokuman" runat="server" AllowDragging="True" ShowOnPageLoad="false" ClientInstanceName="modal"
                        HeaderText="Dosya Yükleme" ShowFooter="false">
                            ...
                            <dx:PopupControlContentControl>
                                <div runat="server">
                                    <dx:ASPxUploadControl ID="UploadControlDokuman" runat="server" ClientInstanceName="UploadControl"
                                        ...
                                        <ValidationSettings MaxFileSize="10000000000" AllowedFileExtensions=".xlsx" ShowErrors="false"></ValidationSettings>
