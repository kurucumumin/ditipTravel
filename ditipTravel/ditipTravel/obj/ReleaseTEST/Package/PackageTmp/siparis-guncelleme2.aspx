<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="siparis-guncelleme2.aspx.cs" Inherits="PortCRMWeb.siparis_guncelleme2" %>
                 ...
                 <asp:Button ID="btnIptaEt" runat="server" class="btn btn-danger" Text="İPTAL ET" OnClick="btnIptaEt_Click" />
                    &nbsp &nbsp
                     ...
                     <dx:ASPxButton ID="btnKaydet" runat="server" Text="GÜNCELLE" CssClass="btn btn-success" OnClick="btnKaydet_Click" AutoPostBack="true">
                       ...
                       &nbsp &nbsp
                 <asp:Button ID="btnOnayla" runat="server" class="btn btn-danger" Text="ONAYLA" OnClick="btnOnayla_Click" Visible="false" />
                </div>
            </div>
