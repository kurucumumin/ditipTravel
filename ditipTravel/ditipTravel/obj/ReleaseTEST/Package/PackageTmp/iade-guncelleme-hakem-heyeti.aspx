<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="iade-guncelleme-hakem-heyeti.aspx.cs" Inherits="PortCRMWeb.iade_guncelleme_hakem_heyeti" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 id="lblGuncellemeBaslik" runat="server" class="m-0 text-dark">İade Güncelleme</h1>
                        <h1 id="lblKopyalamaBaslik" runat="server" class="m-0 text-dark" visible="false">İade Kopyalama</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="main.aspx">Anasayfa</a></li>
                            <li id="lblGuncellemeAltBaslik" runat="server" class="breadcrumb-item active">İade Güncelleme</li>
                            <li id="lblKopyalamaAltBaslik" runat="server" class="breadcrumb-item active" visible="false">İade Kopyalama</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
        ...
        <div class="content" style="padding-left: 30px; padding-right: 30px;">
            ...
            <div style="display: flex; justify-content: flex-end">
                ...
                &nbsp &nbsp 
                 <asp:Button ID="btnIptaEt" runat="server" class="btn btn-danger" Text="İPTAL ET" OnClick="btnIptaEt_Click" />
                &nbsp &nbsp
                        <asp:Button ID="btnKaydet" runat="server" class="btn btn-success" Text="GÜNCELLE" OnClick="btnKaydet_Click" />
            </div>
            ...
            <div class="form-row">
                ...
                <div class="col-7">
                    <dx:ASPxComboBox ID="cmbBayi" CssClass="form-control" runat="server" ValueType="System.String" Width="100%" AutoPostBack="true">
                    </dx:ASPxComboBox>
                </div>
            </div>
                    ...
                    <dx:PopupControlContentControl>
                        ...
                        <div style="padding: 10px;">
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" runat="server" CssClass="grid" Theme="Material" Width="100%" AutoGenerateColumns="False" EnableCallBacks="False">
                                ...
                                <Columns>
                                    <dx:GridViewCommandColumn ShowSelectCheckbox="True" Width="5%" VisibleIndex="0" />
                                    <dx:GridViewDataTextColumn FieldName="Kod" Caption="Ürün Kodu" Width="15%" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Aciklama" Caption="Ürün Adı" Width="20%" VisibleIndex="2">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="IMEI" Caption="IMEI" VisibleIndex="3" MaxWidth="0">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="OrderNumber" Caption="Sipariş Numarası" Width="15%" VisibleIndex="4">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Tutar" Caption="Tutar" PropertiesTextEdit-DisplayFormatString="c" VisibleIndex="5" Width="10%">
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                                <Styles>
                                    <Cell Wrap="False" />
                        ...
                        <%-- <dx:LinqServerModeDataSource ID="LinqServerModeDataSource1" runat="server" ContextTypeName="PortB2B.vtDataContext" TableName="viewIadeUrunPopups" OnSelecting="LinqServerModeDataSource1_Selecting" />--%>
                    </dx:PopupControlContentControl>
                </ContentCollection>
            </dx:ASPxPopupControl>
                        ...
                        <dx:ASPxGridView ID="ASPxGridView2" runat="server" Theme="Material" Width="100%" AutoGenerateColumns="False" EnableCallBacks="False">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="IMEI" Caption="IMEI" Width="100%" VisibleIndex="1">
                                   ...
                                   <dx:GridViewDataCheckColumn FieldName="AKTIVASYON" Caption="AKTİVASYON" Width="100%" VisibleIndex="2">
                                </dx:GridViewDataCheckColumn>
                                  <dx:GridViewDataCheckColumn FieldName="FF" Caption="FİYAT FARKI" Width="100%" VisibleIndex="3">
                                </dx:GridViewDataCheckColumn>
                                  <dx:GridViewDataCheckColumn FieldName="DIGERPRIM" Caption="DİĞER PRİM" Width="100%" VisibleIndex="4">
                                </dx:GridViewDataCheckColumn>
                            </Columns>
                            <Styles>
                                <Cell Wrap="False" />
