<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="satin-alma-guncelle.aspx.cs" Inherits="PortCRMWeb.satin_alma_guncelle" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 id="lblGuncellemeBaslik" runat="server" class="m-0 text-dark">Satın Alma Güncelleme</h1>
                        <h1 id="lblKopyalamaBaslik" runat="server" class="m-0 text-dark" visible="false">Satın Alma Kopyalama</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="main.aspx">Anasayfa</a></li>
                            <li id="lblGuncellemeAltBaslik" runat="server" class="breadcrumb-item active">Satın Alma Güncelleme</li>
                            <li id="lblKopyalamaAltBaslik" runat="server" class="breadcrumb-item active" visible="false">Satın Alma Kopyalama</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
