<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="urun-yonetimi.aspx.cs" Inherits="PortCRMWeb.urun_yonetimi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
        ...
        <div class="content" style="padding-left: 30px; padding-right: 30px;">
            ...
            <dx:ASPxGridView Paddings-PaddingBottom="100" ID="ASPxGridView1" runat="server" Width="100%" CssClass="grid" Theme="Material" ClientInstanceName="grid" AutoGenerateColumns="False" OnRowUpdating="ASPxGridView1_RowUpdating">
               ...
               <%-- <SettingsAdaptivity AdaptivityMode="HideDataCells" AllowOnlyOneAdaptiveDetailExpanded="true"
                ...
                <Columns>
                    <dx:GridViewCommandColumn ShowCancelButton="true" ShowEditButton="true" Width="150" VisibleIndex="0" />
                    <dx:GridViewDataTextColumn FieldName="CODE" Caption="Ürün Kodu" VisibleIndex="0" ReadOnly="True" Width="150">
                        <EditFormSettings Visible="False"></EditFormSettings>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="NAME" Caption="Ürün Adı" ReadOnly="True" VisibleIndex="1"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="KATEGORI" Caption="Kategori" ReadOnly="True" VisibleIndex="2" Width="150"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="MARKA" Caption="Marka" ReadOnly="True" VisibleIndex="3" Width="150"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn FieldName="CRM" VisibleIndex="4" Caption="CRM" AdaptivePriority="1" Width="80">
                    </dx:GridViewDataCheckColumn>
                    <dx:GridViewDataCheckColumn FieldName="B2B" VisibleIndex="5" Caption="B2B" AdaptivePriority="1" Width="80">
                    </dx:GridViewDataCheckColumn>
                    <dx:GridViewDataCheckColumn FieldName="Alokasyon" VisibleIndex="6" Caption="Alokasyon" AdaptivePriority="1" Width="150">
                    </dx:GridViewDataCheckColumn>
                    <dx:GridViewDataTextColumn FieldName="STOK" Caption="Fiziki Stok" ReadOnly="True" VisibleIndex="7" Width="150"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="RezerveAdet" Caption="Rezerve Adet" VisibleIndex="7" Width="150"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="SanalStokAdet" Caption="Sanal Stok Adet" VisibleIndex="8" Width="150" Visible="false"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="SiparisStok" Caption="Sipariş Stok" VisibleIndex="9" Width="150" Visible="false"></dx:GridViewDataTextColumn>
                </Columns>
