<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="iade-guncelleme.aspx.cs" Inherits="PortCRMWeb.iade_guncelleme" %>
           ...
           <br />
            ...
            <div class="form-row">
             ...
             <div class="form-row" id="divFatura" runat="server">
                ...
                <div class="col-2">
                     <dx:ASPxMemo ID="txtFaturaNo" CssClass="form-control" runat="server" Width="100%" ReadOnly="true">
                    </dx:ASPxMemo>
                </div>
            </div>
             ...
             <div class="form-row">
                <div class="col-3">
                  ...
                  <div class="col-2">
                     <dx:ASPxMemo ID="txtSiparisNo" CssClass="form-control" runat="server" Width="100%" ReadOnly="true">
                    </dx:ASPxMemo>
                </div>
                    ...
                    <dx:PopupControlContentControl>
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" CssClass="grid" Theme="Material" Width="100%" AutoGenerateColumns="False" EnableCallBacks="False">
                           ...
                           <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="Kod" Caption="Ürün Kodu" Width="50" VisibleIndex="1">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="Aciklama" Caption="Ürün Adı" Width="100%" VisibleIndex="2">
                                </dx:GridViewDataTextColumn>
                                 <dx:GridViewDataTextColumn FieldName="IMEI" Caption="IMEI" Width="50%" VisibleIndex="2">
                                </dx:GridViewDataTextColumn>
                                 <dx:GridViewDataTextColumn FieldName="Tutar" Caption="Tutar" PropertiesTextEdit-DisplayFormatString="c" VisibleIndex="3">
                                </dx:GridViewDataTextColumn>
                            </Columns>
                            <Styles>
                                <Cell Wrap="False" />
