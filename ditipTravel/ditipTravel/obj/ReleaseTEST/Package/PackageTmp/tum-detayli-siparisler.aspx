<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="tum-detayli-siparisler.aspx.cs" Inherits="PortCRMWeb.tum_detayli_siparisler" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Tüm Sipariş Kalemleri</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="main.aspx">Anasayfa</a></li>
                            <li class="breadcrumb-item active">Tüm Sipariş Kalemleri</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
        ...
        <div class="content" style="padding-left: 30px; padding-right: 30px;">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <dx:ASPxRadioButtonList ID="radioButtonList" SelectedIndex="0" runat="server" RepeatColumns="4" RepeatLayout="Flow" AutoPostBack="true" OnSelectedIndexChanged="radioButtonList_SelectedIndexChanged">
                        <CaptionSettings Position="Top" />
                        <Items>
                            <dx:ListEditItem Text="Tüm Ürünler" Value="0" />
                            <dx:ListEditItem Text="Cihaz" Value="1" />
                            <dx:ListEditItem Text="Aksesuar" Value="2" />
                            <dx:ListEditItem Text="B2B" Value="3" />
                            <%-- <dx:ListEditItem Text="Bu Gün" Value="3" Selected="true" />--%>
                        </Items>
            ...
            <dx:ASPxGridView Paddings-PaddingBottom="100" ID="ASPxGridView1" ClientInstanceName="grid" runat="server" Theme="Material" Width="100%" AutoGenerateColumns="False"
                CssClass="grid" EnableRowsCache="false" DataSourceID="LinqServerModeDataSource1" KeyFieldName="SiNo">
            ...
            <%--    <SettingsAdaptivity AdaptivityMode="HideDataCells" AllowOnlyOneAdaptiveDetailExpanded="true"
                ...
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="SiNo" VisibleIndex="0" ReadOnly="True" Visible="false" Width="50" Caption="PSON">
                        <EditFormSettings Visible="False"></EditFormSettings>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="No" VisibleIndex="0" ReadOnly="True" Width="50" Caption="PSON">
                        <EditFormSettings Visible="False"></EditFormSettings>
                    </dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataTextColumn FieldName="TeslimatAdresi" VisibleIndex="3"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="UrunKodu" VisibleIndex="4"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="UrunAciklamasi" VisibleIndex="5"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Miktar" VisibleIndex="6"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Fiyati" VisibleIndex="7" PropertiesTextEdit-DisplayFormatString="c"></dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataDateColumn FieldName="OlusturmaTarih" VisibleIndex="9" ShowInCustomizationForm="True">
                        <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy HH:MM:ss" EditFormat="DateTime"></PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn FieldName="OlusturanKisi" VisibleIndex="10"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="satisSiparisDurumu" VisibleIndex="11"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn FieldName="Mars" VisibleIndex="12"></dx:GridViewDataCheckColumn>
                    <dx:GridViewDataCheckColumn FieldName="MarsKismi" Caption="Mars Çıkış" VisibleIndex="13"></dx:GridViewDataCheckColumn>
                    <dx:GridViewDataCheckColumn FieldName="Red" VisibleIndex="14"></dx:GridViewDataCheckColumn>
                    <dx:GridViewDataTextColumn FieldName="odemeKaydiTipi" VisibleIndex="15"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="NAME3" VisibleIndex="16" Visible="false"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataCheckColumn FieldName="B2B" VisibleIndex="17"></dx:GridViewDataCheckColumn>
                </Columns>
                    ...
                    <DetailRow>
                        ...
                        <dx:ASPxGridView ID="detailGrid" runat="server" KeyFieldName="IMEI" CssClass="grid"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="UrunKodu" ReadOnly="True" VisibleIndex="1"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="MarkaModel" VisibleIndex="2"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="IrsaliyeNo" VisibleIndex="3"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="FisNo" VisibleIndex="4"></dx:GridViewDataTextColumn>
                            </Columns>
            ...
            <dx:LinqServerModeDataSource ID="LinqServerModeDataSource1" runat="server" ContextTypeName="PortB2B.vtDataContext" TableName="DetayliSiparisRaporus" OnSelecting="LinqServerModeDataSource1_Selecting" />
        </div>
