<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="onay-bekleyen-satin-almalarim.aspx.cs" Inherits="PortCRMWeb.onay_bekleyen_satin_almalarim" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Onay Bekleyen Satın Almalarım</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="main.aspx">Anasayfa</a></li>
                            <li class="breadcrumb-item active">Onay Bekleyen Satın Almalarım</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
        ...
        <div class="content" style="padding-left: 30px; padding-right: 30px;">
            <div style="display: flex; justify-content: flex-end">
                <a href="satin-alma-girisi.aspx" class="btn btn-sm btn-info float-left" id="yeniSiparis" runat="server">Yeni Satın Alma +</a>
            </div>
            ...
            <dx:ASPxGridView Paddings-PaddingBottom="100" ID="ASPxGridView1" ClientInstanceName="grid" runat="server" Theme="Material" Width="100%" AutoGenerateColumns="False"
               ...
               <%-- <SettingsAdaptivity AdaptivityMode="HideDataCells" AllowOnlyOneAdaptiveDetailExpanded="true"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="Tutar" VisibleIndex="3" PropertiesTextEdit-DisplayFormatString="c" Width="5%"></dx:GridViewDataTextColumn>
                     <dx:GridViewDataTextColumn FieldName="ToplamAdet" VisibleIndex="4" Width="5%"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="OlusturanKisi" ReadOnly="True" VisibleIndex="5" Width="10%"></dx:GridViewDataTextColumn>
                      <dx:GridViewDataTextColumn FieldName="OlusturmaTarih" VisibleIndex="6" Width="10%"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Aciklama" VisibleIndex="7" Width="30%"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="SiparisDurumu" Caption="Satın Alma Durumu" VisibleIndex="8" Width="10%"></dx:GridViewDataTextColumn>
