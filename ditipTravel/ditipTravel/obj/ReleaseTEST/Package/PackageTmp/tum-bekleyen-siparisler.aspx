<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="tum-bekleyen-siparisler.aspx.cs" Inherits="PortCRMWeb.tum_bekleyen_siparisler" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Bekleyen Siparişler</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="content" style="padding-left: 30px; padding-right: 30px;">
            ...
            <dx:ASPxGridView ID="ASPxGridView1" runat="server" CssClass="grid" Theme="Material" Width="100%" AutoGenerateColumns="False" EnableCallBacks="False">
               ...
               <%-- <SettingsAdaptivity AdaptivityMode="HideDataCells" AllowOnlyOneAdaptiveDetailExpanded="true"
                ...
                <Columns>
                      <dx:GridViewDataTextColumn FieldName="SiparisNumarasi" Caption="Sipariş Numarası" Width="5%" VisibleIndex="0">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="UrunKodu" Caption="Ürün Kodu" Width="10%" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                       <dx:GridViewDataTextColumn FieldName="UrunAciklamasi" Caption="Ürün Açıklaması" Width="10%" VisibleIndex="2">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Miktar" Caption="Adet" Width="5%" VisibleIndex="3">
                    </dx:GridViewDataTextColumn>
                </Columns>
