<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="siparis-girisi.aspx.cs" Inherits="PortCRMWeb.siparis_girisi" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Sipariş Girişi</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="main.aspx">Anasayfa</a></li>
                            <li class="breadcrumb-item active">Sipariş Girişi</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
        ...
        <div class="content" style="padding-left: 30px; padding-right: 30px;">
            ...
            <div class="form-row">
                ...
                <div class="col-sm-3" style="position:relative; text-align:right">
