<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="crm-mars-logo-karsilastirma-raporu.aspx.cs" Inherits="PortCRMWeb.crm_mars_logo_karsilastirma_raporu" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">CRM-MARS-LOGO Karşılaştırma Raporu</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="main.aspx">Anasayfa</a></li>
                            <li class="breadcrumb-item active">CRM-MARS-LOGO Karşılaştırma Raporu</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
        ...
        <div class="content" style="padding-left: 30px; padding-right: 30px;">
            ...
            <dx:ASPxGridView ID="grid1" runat="server" KeyFieldName="IMEI" Width="100%" CssClass="grid" Theme="Material">
              ...
              <%--  <SettingsAdaptivity AdaptivityMode="HideDataCells" AllowOnlyOneAdaptiveDetailExpanded="true"
                ...
                <%--<Columns>
                    <dx:GridViewDataTextColumn FieldName="IMEI" VisibleIndex="0"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="MarkaModel" VisibleIndex="1" Caption="Marka - Model"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="SiparisNo" VisibleIndex="2" Caption="Sipariş No"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="IrsaliyeNo" VisibleIndex="3" Caption="İrsaliye No"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="FisNo" VisibleIndex="4" Caption="Fatura No"></dx:GridViewDataTextColumn>
                </Columns>--%>
