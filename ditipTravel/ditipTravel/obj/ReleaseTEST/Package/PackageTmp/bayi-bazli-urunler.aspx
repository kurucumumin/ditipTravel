<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="bayi-bazli-urunler.aspx.cs" Inherits="PortCRMWeb.bayi_bazli_urunler" %>
    ...
    <div class="content-wrapper">
        ...
        <div class="content" style="padding-left: 30px; padding-right: 30px;">
            ...
            <div class="form-row">
                ...
                <div class="col-5">
                    <dx:ASPxComboBox ID="cmbBayi" CssClass="form-control" runat="server" ValueType="System.String" Width="50%" AutoPostBack="true"></dx:ASPxComboBox>
                </div>
            </div>
